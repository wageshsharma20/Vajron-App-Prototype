...
export const I18nProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  "Play area · lake edge · open-gym & lawns · footbridge · works zone": "खेल क्षेत्र · झील का किनारा · ओपन-जिम और लॉन · फुटब्रिज · कार्य क्षेत्र",
  ...
  "Jasola Vihar · Surveyed 19 May 2026": "जसोला विहार · सर्वेक्षण 19 मई 2026",
  "East Delhi · Surveyed 19 May 2026": "पूर्वी दिल्ली · सर्वेक्षण 19 मई 2026",
  "Rohini · Surveyed 22 May 2026": "रोहिणी · सर्वेक्षण 22 मई 2026",
  ...
  "Greater Kailash · Surveyed 18 May 2026": "ग्रेटर कैलाश · सर्वेक्षण 18 मई 2026",
  ...
  "SELECT A PARK": "पार्क चुनें",
  "Choose a park": "एक पार्क चुनें",
  "WHAT THE SURVEY FOUND": "सर्वेक्षण में क्या मिला",
  "NEEDS ATTENTION NOW": "अभी ध्यान देने की आवश्यकता",
  "WORTH LOOKING AT": "देखने योग्य",
  "FOR INFORMATION": "जानकारी के लिए",
  "No photo": "कोई फ़ोटो नहीं",

  // ── Survey findings ──────────────────────────────────────────────────
  // The wording the app raises as a notification during playback and lists
  // in the issue locator. Kept together so the two stay in step.
  "Hedges need a trim": "बाड़ों की कटाई-छँटाई ज़रूरी है",
  "Bare patches on the lawn": "लॉन में खाली जगहें",
  "Lake water looking murky": "झील का पानी गँदला दिख रहा है",
  "Shoreline needs cleanup": "किनारे की सफ़ाई ज़रूरी है",
  "Floating waste in the lake": "झील में तैरता कचरा",
  "Algae spreading in the channel": "नाले में काई फैल रही है",
  "Bank erosion visible": "किनारे का कटाव दिख रहा है",
  "Some litter near the banks": "किनारों के पास थोड़ा कचरा",
  "Dry patches along the bank": "किनारे के साथ सूखे हिस्से",
  "Waterlogging detected": "जलभराव मिला",
  "Dry patches on the lawn": "लॉन में सूखे हिस्से",
  "Dry vegetation flagged": "सूखी वनस्पति चिह्नित",
  "Bare patches spreading": "खाली ज़मीन फैल रही है",
  "Construction debris on footbridge": "पैदल पुल पर निर्माण मलबा",
  "Construction debris on the pathway": "रास्ते पर निर्माण मलबा",
  "Bare patches showing": "खाली जगहें दिख रही हैं",
  "Some litter about": "थोड़ा कचरा बिखरा है",
  "More bare patches ahead": "आगे और खाली जगहें",
  "Lawn could use attention": "लॉन पर ध्यान देना अच्छा रहेगा",
  "Canopy looking thin": "पेड़ों की छाँव कुछ पतली है",
  "A few bare patches": "कुछ खाली जगहें",
  "Standing water observed": "जमा पानी दिखा",
  "Fallen leaves piling up": "गिरे हुए पत्ते जमा हो रहे हैं",
  "Play equipment broken — critical": "खेल उपकरण टूटा — गंभीर",
  "Algae risk from stagnant water": "रुके पानी से काई का ख़तरा",
  "Ground cover thinning": "ज़मीन की हरियाली पतली हो रही है",
  "Pavilion structure deteriorating": "मंडप की संरचना कमज़ोर हो रही है",
  "Some dry vegetation": "कुछ सूखी वनस्पति",
  "Building needs repair": "इमारत की मरम्मत ज़रूरी है",
  "Play area flooring damaged": "खेल क्षेत्र का फ़र्श क्षतिग्रस्त",
  "Path surface worn": "रास्ते की सतह घिस गई है",
  "Shrubs showing wear": "झाड़ियों में घिसाव दिख रहा है",
  "Litter building up": "कचरा जमा हो रहा है",
  "Hedges degrading": "बाड़ों की हालत बिगड़ रही है",
  "Bare patches and dry vegetation": "खाली जगहें और सूखी वनस्पति",
  "Ground wearing thin": "ज़मीन की परत पतली हो रही है",
  "Ground condition critical": "ज़मीन की हालत गंभीर",
  "Path surface degrading": "रास्ते की सतह ख़राब हो रही है",
  "Hedge beds looking uneven along the edges — a trim would tidy things up.": "किनारों पर बाड़ की क्यारियाँ असमान दिख रही हैं — छँटाई से सब व्यवस्थित हो जाएगा।",
  "Patches of bare ground showing through the lawn — needs replanting.": "लॉन के बीच खाली ज़मीन दिख रही है — दोबारा रोपाई ज़रूरी है।",
  "Water quality appears poor — greenish tinge suggests algae buildup.": "पानी की गुणवत्ता ख़राब लग रही है — हरापन काई जमने का संकेत देता है।",
  "Debris visible along the lake edge — clearing would improve the look.": "झील के किनारे मलबा दिख रहा है — सफ़ाई से रूप बेहतर होगा।",
  "Waste floating on the surface — needs immediate skimming and cleanup.": "सतह पर कचरा तैर रहा है — तुरंत हटाने और सफ़ाई की ज़रूरत है।",
  "Green algae coating the channel surface — water circulation needed.": "नाले की सतह पर हरी काई की परत — पानी के प्रवाह की ज़रूरत है।",
  "Channel banks wearing away in spots — could use reinforcement.": "नाले के किनारे जगह-जगह कट रहे हैं — मज़बूती देना अच्छा रहेगा।",
  "Loose debris along the channel edge — a cleanup would help.": "नाले के किनारे बिखरा मलबा — सफ़ाई से मदद मिलेगी।",
  "Plant cover thinning on the banks — watering and replanting needed.": "किनारों पर पौधों की परत पतली हो रही है — सिंचाई और दोबारा रोपाई ज़रूरी है।",
  "Standing water in the children's play area — investigate drainage.": "बच्चों के खेल क्षेत्र में जमा पानी — जल निकासी की जाँच करें।",
  "Dry, stressed turf visible across the play area lawn — irrigation check needed.": "खेल क्षेत्र के लॉन में सूखी, कमज़ोर घास दिख रही है — सिंचाई की जाँच ज़रूरी है।",
  "2–3 trees showing dry, stressed canopy — schedule irrigation and inspection.": "2–3 पेड़ों की छाँव सूखी और कमज़ोर दिख रही है — सिंचाई और निरीक्षण तय करें।",
  "Bare, compacted ground along the pathway — re-turfing and decompaction recommended.": "रास्ते के साथ खाली, दबी हुई ज़मीन — दोबारा घास लगाने और ज़मीन ढीली करने की सलाह है।",
  "Construction debris detected on the footbridge — clear the site and verify safety barriers.": "पैदल पुल पर निर्माण मलबा मिला — जगह साफ़ करें और सुरक्षा अवरोध जाँचें।",
  "Rubble and broken brick piled directly on the walking track — clear the route and barricade the works area.": "पैदल पथ पर सीधे मलबा और टूटी ईंटें पड़ी हैं — रास्ता साफ़ करें और कार्य क्षेत्र की घेराबंदी करें।",
  "Ground cover thinning under the palm avenue — could use re-turfing.": "ताड़ की कतार के नीचे ज़मीन की हरियाली पतली हो रही है — दोबारा घास लगाना अच्छा रहेगा।",
  "A bit of loose debris across the lawns — a sweep would tidy it up.": "लॉन में थोड़ा बिखरा मलबा — झाड़ू लगाने से साफ़ हो जाएगा।",
  "Bare ground expanding along the far end of the avenue — needs re-turfing.": "कतार के दूसरे छोर पर खाली ज़मीन बढ़ रही है — दोबारा घास लगाना ज़रूरी है।",
  "Turf patchy around the formal beds — aerating and overseeding would help.": "क्यारियों के आसपास घास जगह-जगह पतली है — हवा देना और बीज डालना मदद करेगा।",
  "Tree canopy a little sparse here — some watering would help.": "यहाँ पेड़ों की छाँव कुछ विरल है — थोड़ी सिंचाई मदद करेगी।",
  "Grass thinning beside the axis — overseeding would bring it back.": "मुख्य पथ के किनारे घास पतली हो रही है — बीज डालने से वापस आ जाएगी।",
  "Some bare ground along the central axis — could do with re-turfing.": "मुख्य पथ के साथ कुछ खाली ज़मीन — दोबारा घास लगाई जा सकती है।",
  "Water pooling in the planting bed — worth checking the drainage here.": "क्यारी में पानी जमा हो रहा है — यहाँ जल निकासी जाँचना ठीक रहेगा।",
  "A bit of loose debris across the bed — a sweep would tidy it up.": "क्यारी में थोड़ा बिखरा मलबा — झाड़ू लगाने से साफ़ हो जाएगा।",
  "Leaf litter accumulating across the play area — needs a good sweep before it gets slippery.": "खेल क्षेत्र में पत्ते जमा हो रहे हैं — फिसलन होने से पहले अच्छी सफ़ाई ज़रूरी है।",
  "Water pooling in the play area — worth checking the drainage.": "खेल क्षेत्र में पानी जमा हो रहा है — जल निकासी जाँचना ठीक रहेगा।",
  "Swing appears collapsed on the sand. Inspect and make safe before reopening.": "झूला रेत पर गिरा हुआ लग रहा है। दोबारा खोलने से पहले जाँचें और सुरक्षित करें।",
  "Water lying across the open ground — worth a look at levels and drainage.": "खुली ज़मीन पर पानी फैला है — ढलान और जल निकासी देखना ठीक रहेगा।",
  "Prolonged waterlogging could breed algae and mosquitoes — drainage needs urgent attention to prevent disease spread.": "लंबे समय तक जलभराव से काई और मच्छर पनप सकते हैं — बीमारी फैलने से रोकने के लिए जल निकासी पर तुरंत ध्यान ज़रूरी है।",
  "Ground is bare and compacted in places — decompacting and re-turfing would help.": "ज़मीन जगह-जगह खाली और दबी हुई है — ढीला करने और दोबारा घास लगाने से मदद मिलेगी।",
  "A bit of loose debris across the open ground — worth a sweep.": "खुली ज़मीन पर थोड़ा बिखरा मलबा — झाड़ू लगाना ठीक रहेगा।",
  "Some compacted ground along the path — could do with re-turfing.": "रास्ते के साथ कुछ दबी हुई ज़मीन — दोबारा घास लगाई जा सकती है।",
  "Grass thinning in patches — aerating and overseeding would bring it back.": "घास जगह-जगह पतली हो रही है — हवा देने और बीज डालने से वापस आ जाएगी।",
  "A few gaps showing along the shrub line — trimming and gap-filling would tidy it.": "झाड़ियों की कतार में कुछ ख़ाली जगहें दिख रही हैं — छँटाई और भराई से व्यवस्थित हो जाएगा।",
  "Shrub line growing uneven under the canopy — trimming would tidy it.": "छाँव के नीचे झाड़ियों की कतार असमान बढ़ रही है — छँटाई से व्यवस्थित हो जाएगी।",
  "Grass thinning in places — overseeding would bring it back.": "घास जगह-जगह पतली हो रही है — बीज डालने से वापस आ जाएगी।",
  "Infrastructure showing signs of wear — cracks and peeling visible on the building.": "ढाँचे में घिसाव के संकेत — इमारत पर दरारें और पपड़ी दिख रही है।",
  "Patches of dry growth near the pavilion — a watering round would help.": "मंडप के पास सूखी वनस्पति के हिस्से — एक बार सिंचाई मदद करेगी।",
  "Pavilion exterior in poor condition — repainting and structural repair recommended.": "मंडप का बाहरी हिस्सा ख़राब हालत में — दोबारा रंगाई और ढाँचे की मरम्मत की सलाह है।",
  "Tiles and floor surface in the children's play area are cracked and broken — repair needed for safety.": "बच्चों के खेल क्षेत्र की टाइलें और फ़र्श टूटे और चटके हैं — सुरक्षा के लिए मरम्मत ज़रूरी है।",
  "Loose debris scattered across the area — a good sweep would tidy things up.": "पूरे क्षेत्र में बिखरा मलबा — अच्छी सफ़ाई से सब व्यवस्थित हो जाएगा।",
  "Bare, compacted ground under the equipment — could do with re-turfing.": "उपकरणों के नीचे खाली, दबी हुई ज़मीन — दोबारा घास लगाई जा सकती है।",
  "Grass thinning around the edges — aerating and overseeding would help.": "किनारों पर घास पतली हो रही है — हवा देना और बीज डालना मदद करेगा।",
  "Bare, compacted ground along the path — decompacting and re-turfing would help.": "रास्ते के साथ खाली, दबी हुई ज़मीन — ढीला करने और दोबारा घास लगाने से मदद मिलेगी।",
  "Walking track showing wear along this stretch — worth patching.": "इस हिस्से में पैदल पथ पर घिसाव दिख रहा है — मरम्मत करना ठीक रहेगा।",
  "Gaps showing along the shrub line — trimming and gap-filling would tidy it.": "झाड़ियों की कतार में ख़ाली जगहें दिख रही हैं — छँटाई और भराई से व्यवस्थित हो जाएगा।",
  "Hedge condition dipping near the fountain — gaps and thinning visible.": "फ़व्वारे के पास बाड़ की हालत गिर रही है — ख़ाली जगहें और पतलापन दिख रहा है।",
  "Ground litter detected along the avenue — condition at 36%, needs attention.": "कतार के साथ ज़मीन पर कचरा मिला — हालत 36%, ध्यान देना ज़रूरी है।",
  "Multiple shrub lines showing poor condition — trimming and gap-filling recommended.": "झाड़ियों की कई कतारें ख़राब हालत में — छँटाई और भराई की सलाह है।",
  "Compacted ground and dry vegetation cluster detected — irrigation review needed.": "दबी हुई ज़मीन और सूखी वनस्पति का समूह मिला — सिंचाई की समीक्षा ज़रूरी है।",
  "Some bare patches visible near the gym area — minor re-turfing would help.": "व्यायाम क्षेत्र के पास कुछ खाली जगहें दिख रही हैं — थोड़ी घास लगाने से मदद मिलेगी।",
  "Exposed ground expanding across the hedge bed zone — needs soil treatment and re-seeding.": "बाड़ की क्यारी वाले क्षेत्र में खुली ज़मीन बढ़ रही है — मिट्टी उपचार और दोबारा बीज डालना ज़रूरी है।",
  "Bare ground at 6% condition — worst finding in this survey. Immediate action required.": "खाली ज़मीन की हालत 6% — इस सर्वेक्षण की सबसे ख़राब स्थिति। तुरंत कार्रवाई ज़रूरी है।",
  "Walking track wearing thin at the far end — resurfacing recommended.": "दूसरे छोर पर पैदल पथ घिस रहा है — सतह दोबारा बनाने की सलाह है।",

  "issue found": "समस्या मिली",
  "issues found": "समस्याएँ मिलीं",
  "Open the photo full screen": "फ़ोटो को पूर्ण स्क्रीन में खोलें",
  "Open this location in Google Maps": "इस स्थान को गूगल मैप्स में खोलें",
  "Close": "बंद करें",
  "Pick a park above to see what its survey found.": "ऊपर एक पार्क चुनें और देखें कि उसके सर्वेक्षण में क्या मिला।",
  "Locations are approximate — read from satellite imagery, not recorded by the drone.": "स्थान अनुमानित हैं — उपग्रह चित्रों से लिए गए हैं, ड्रोन द्वारा दर्ज नहीं किए गए।",
  "Automated Compliance & Audit": "स्वचालित अनुपालन और ऑडिट",
  "Automated Findings & Locations": "स्वचालित निष्कर्ष और स्थान",
  ...
  "5-clip survey": "5-क्लिप सर्वेक्षण",
