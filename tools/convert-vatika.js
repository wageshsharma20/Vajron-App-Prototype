/**
 * Convert the Vasant Vatika AI detection workbook into replay JSON the app plays.
 *
 * This workbook follows the same layout as Vasant Udyan: a multi-clip survey
 ...
 *
 * Run:  node tools/convert-vatika.js
 */
const fs = require('fs');
...
const XLSX =
  process.argv[3] || '/Users/wageshsharma/Downloads/Vasant_Vatika_AI_Detection_Report.xlsx';
...
// ---------------------------------------------------------------- xlsx reader
const TMP = path.join(require('os').tmpdir(), 'vatika-xlsx-conv');
